...
import useMapMarker from '@/hook/useMapMarker'
 ...
 * 
 * **마커 종류:**
 * - 파란색 파동 마커: 사용자 현재 위치 (useMapMarker)
...
export default function BasicMap() {
   ...
   * - 클릭 시 콘솔에 로그 출력
   */
  useMapMarker(map, location, () => console.log('내 위치 마커 클릭됨!'))
    ...
    <div className="relative h-screen w-full">
      {/* 
        ...
        - onCreate: 지도 생성 완료 시 콜백 (map 인스턴스 반환)
                    ...
                    다른 훅들(useMapMarker, useListingMarkers)에서 사용
      */}
      <Map
        id="map"
