  ...
  return (
    <div className="bg-white px-4 pb-4">
      ...
      <Select value={value} onValueChange={onSelect}>
        <SelectTrigger className="w-full flex-1 cursor-pointer rounded-lg border border-gray-300 bg-white px-4 py-2 text-base text-gray-500 transition-colors outline-none hover:border-blue-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100">
