    ...
    <div className="bg-white px-4 pt-4">
      <div>
        ...
        <input
          ...
          maxLength={maxLength}
          className="w-full rounded-lg border border-gray-300 px-4 py-2 text-base transition-colors outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
        />
