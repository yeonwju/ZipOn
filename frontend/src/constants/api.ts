...
export const API_ENDPOINTS = {
  ...
  LISTINGS_AUCTION: `/api/v1/properties/list?type=auction`,
  LISTINGS_GENERAL: `/api/v1/properties/list?type=general`,
  LISTINGS_BRK: `/api/v1/properties/list?type=broker`,
